...
urlpatterns = [
    ...
    path('password-reset/',auth_view.PasswordResetView.as_view(template_name='app/password_rest.html',form_class=MypasswordResetForm), name='password_reset'),
...
admin.site.site_header = "Giridhar Dairy"
admin.site.site_title = "Giridhar Dairy"
admin.site.site_index_title = "Welcome to Giridhar Dairy Shop"